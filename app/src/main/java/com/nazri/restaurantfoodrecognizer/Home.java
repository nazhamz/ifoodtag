...
import com.nazri.restaurantfoodrecognizer.Model.Category;
import com.nazri.restaurantfoodrecognizer.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cam)
        {
            Intent cam = new Intent(Home.this, MainActivity.class);
            startActivity(cam);
        }

        else if (id == R.id.nav_foodlist)
        {
            Intent foodlist = new Intent(Home.this,ListOfFood.class);
            startActivity(foodlist);
        }

        else if (id == R.id.nav_receipt)
        {
            Intent receipt = new Intent(Home.this,ReceiptView.class);
        ...
        else if (id == R.id.nav_about)
        {
            ...
            //logout
            Intent welcome = new Intent(Home.this,WelcomeActivity.class);
