package com.nazri.restaurantfoodrecognizer.helpers;

import com.nazri.restaurantfoodrecognizer.MainActivity;
...
public class HttpHelper {
    ...
    public static String makeRequest(RequestPackage requestPackage, InputStream data)
        ...
        if (requestPackage.getMethod().equals("POST")) {
            ...
            if (iris) {
                requestBuilder.addHeader("Prediction-Key", "4807b9c0bc214ed09e2ce54c91bfeebb");
